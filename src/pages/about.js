...
const About = () => {
  ...
  return (
    <Layout title={siteTitle}>
        ...
        />
        <div className="about">
          <p>¡Hola pequeño byte! Mi nombre es <span className="highlight">Wilmer Terrero</span> (como sí no nos habíamos dado cuenta <span role="img" aria-label="poker_face">😑</span>). Nací en Santo Domingo, República Dominicana 🇩🇴.
          ...
          <p>¡Sin saberlo! Jugaba un juego de rol en Habbo.es (me encantaba jugar a juegos de rol en Habbo), en el que para tener un personaje,
              ...
              &nbsp;<span className="highlight">¡HTML y CSS!</span> Ese fue mi primer encuentro con los lenguajes de marcado, sin ni siquiera saber que existían.</p>
          ...
          &nbsp;objetivos: <span className="highlight">diseño funcional</span>, <span className="highlight">plataforma segura</span>, <span className="highlight">buena experiencia de usuario</span>.</p>
          ...
          Por eso cree este blog, con la temática de <span className="highlight">Lo aprendo, lo enseño</span>. Eso vengo a compartir y evangelizar con ustedes, mis queridos bytes.</p>
